...
import 'package:socialapp/features/presentation/views/description_view/widgets/add_post.dart';
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ListView(
            shrinkWrap: true, // Let ListView take only the space it needs
            physics:
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                              'AddPost')), // Centered the text inside the container
                    ),
                  ),
                ),
              ),
              const SizedBox(
                  height: 20), // Added spacing to avoid any overflow issue
            ],
          ),
        ],
      ),
