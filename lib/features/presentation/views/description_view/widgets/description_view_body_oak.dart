...
class DescriptionViewBodyoak extends StatelessWidget {
  const DescriptionViewBodyoak({super.key});
        ...
        Column(
          children: [
            Container(
                ...
                height: 300,
                child: Image.asset(
                    fit: BoxFit.cover, 'assets/images/oaktrees.jpg')),
            const SizedBox(
              height: 12,
            ),
            const Text(
            ...
            const Padding(
              ...
              child: Row(
                ...
                children: [
                  CustomProfileCard(
                      profImage: 'assets/images/john.png',
                      userName: "John",
